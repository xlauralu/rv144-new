...
In reading the above bar chart, it is easy to observe the almost equal starting point of both vaccines and placebos. In the aids column, we note a rise in the placebo group; utlimately showing its ineffectiveness.
...
According to the above results,the vaccine and placebo's resting data was 99.38 for vaccine and 99.1 for placebo. In comparing the two, aids had affected 0.62% of the vaccine group while only 0.9% of the placebo group had been effected. With each of the groups being almost equal at points of data, one can assume it's ineffective to use the aids vaccine, in contrast to the placebo group. Since the percentages are so low, it is unlikely that the placebo group had any true outcome.
...
According to the above results, the chances of getting aids is rather low due to our previously mentioned Null Hypothesis. The value of the Chi Squared statistic is 3.90, while the probability value is at 0.04. Having taking the vaccine versus the placebo, it looks like one is more likely to get aids if given the placebo. 


## Conclusions
According to all of the information presented throughout the report showing our summary and our graphs, we can assume that the correlation in the aids vaccine and its effects on the placebo group are displayed in the Chi test. While the placebo group believed they we're getting the vaccine, the numbers increased. This diminishes all validity in terms of correlation from the experimental and placebo group, essentially voiding the use of an aids vaccine. Finally, making it ineffective.
